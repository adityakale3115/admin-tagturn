...
export default function Profile() {
  ...
  /* ---------------- FETCH PROFILE (Stable with useCallback) ---------------- */
          ...
          <div className="gl-profile-card">
            ...
            <section className="gl-media-grid">
              <div className="gl-banner-box">
                <img
                  src={previews.banner || profile.shopBanner || "https://via.placeholder.com/1200x400?text=NO_ASSET_LOADED"}
              ...
              <div className="gl-logo-overlay">
                <div className="gl-logo-frame">
                  <img
                    src={previews.logo || profile.shopLogo || "https://via.placeholder.com/150?text=LOGO"}
            ...
            <div className="gl-profile-form">
              <div className="gl-form-grid">
                <div className="gl-input-group">
                  <label className="gl-label"><Store size={14} /> {"REGISTERED_SHOP_NAME"}</label>
                  <input
                    className="gl-input"
                ...
                <div className="gl-input-group">
                  <label className="gl-label"><Phone size={14} /> {"CONTACT_COMM_KEY"}</label>
                  <input
                    className="gl-input"
                    value={profile.phone}
                ...
                <div className="gl-input-group">
                  <label className="gl-label"><Hash size={14} /> {"GST_VERIFICATION_ID"}</label>
                  <input
                    className="gl-input"
                    value={profile.gst}
                ...
                <div className="gl-input-group gl-full-width">
                  <label className="gl-label"><MapPin size={14} /> {"PHYSICAL_NODE_LOCATION"}</label>
                  <textarea
              ...
              <button className="gl-save-btn" onClick={saveProfile} disabled={loading}>
